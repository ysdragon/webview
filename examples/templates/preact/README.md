# Ring WebView + Preact Template

Preact (TypeScript) frontend bundled to a single HTML file with Vite +
...
- The Preact app calls `window.increment()` / `window.decrement()` (each
