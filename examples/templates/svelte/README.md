# Ring WebView + Svelte Template

Svelte (TypeScript) frontend bundled to a single HTML file with Vite +
...
- The Svelte app calls `window.increment()` / `window.decrement()` (each
