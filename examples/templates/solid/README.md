# Ring WebView + SolidJS Template

SolidJS (TypeScript) frontend bundled to a single HTML file with Vite +
...
- The SolidJS app calls `window.increment()` / `window.decrement()` (each
